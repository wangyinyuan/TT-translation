...
<figure>
    <img src="./LanguageIfo.png" style="width: 60%; margin: 10px auto; display: block;">
...
<figure>
    <img src="./TextTranslateReq.png" style="width: 60%; margin: 10px auto; display: block;">
...
<figure>
    <img src="./OCRTranslate.png" style="width: 60%; margin: 10px auto; display: block;">
    <figcaption style="text-align: center; color: gray">文本翻译接口</figcaption>
</figure>
...
<figure>
    <img src="./SpeechTranslateReq.png" style="width: 60%; margin: 10px auto; display: block;">
    <figcaption style="text-align: center; color: gray">文本翻译接口</figcaption>
</figure>
